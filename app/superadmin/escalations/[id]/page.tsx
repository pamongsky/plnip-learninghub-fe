...
export default function SuperadminEscalationDetailPage() {
  ...
  const handleNewReply = useCallback(
    (data: { id: number; escalation_ticket_id: number; user_id: number; message: string; attachments?: string[] | null; is_internal?: boolean; created_at: string; user: { name: string; role?: string } }) => {
