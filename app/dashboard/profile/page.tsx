...
export default function ProfilePage() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      setStatusType("error");
      setStatusMessage(error.response?.data?.message || "Gagal memperbarui password.");
    } finally {
          ...
          <div className="flex flex-col sm:flex-row sm:items-end gap-4">
            ...
            <div className="flex-1 pt-2 sm:pt-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[10px] text-slate-500 dark:text-slate-400">Email terverifikasi</span>
              </div>
            </div>
            <motion.button
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300 }}>
                  ...
                  />
                  <p className="mt-1 text-[10px] text-slate-400">Email dikunci oleh sistem</p>
                </motion.div>
                <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300 }}>
                  <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2">
                ...
                <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300 }}>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-800 dark:text-white focus:ring-2 focus:ring-pln-primary/20 focus:border-pln-primary disabled:bg-slate-50 dark:disabled:bg-slate-700/50 disabled:text-slate-500 dark:disabled:text-slate-400 transition-all"
                  />
                  <p className="mt-1 text-[10px] text-slate-400">Unit kerja berasal dari database</p>
                </motion.div>
                <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300 }}>
                  <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">Gunakan minimal 8 karakter</p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-white dark:bg-slate-600 rounded-lg">
                    <div>
                      <p className="text-sm text-slate-700 dark:text-white">{deviceLabel}</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">Perangkat ini</p>
                    </div>
