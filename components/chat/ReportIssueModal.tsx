...
const categories = [
  {
    ...
    desc: "Kendala login, error sistem, bug, atau akses platform",
  },
  {
    value: "learning",
    label: "Masalah Pembelajaran",
    desc: "Masalah konten, video, kuis, atau materi kelas",
  },
  {
    value: "certificate",
    label: "Masalah Sertifikat",
    desc: "Sertifikat belum muncul, salah nama, atau gagal download",
  },
  {
    value: "other",
    label: "Lainnya",
    desc: "Pertanyaan umum atau kendala di luar kategori di atas",
  },
];
